    ...
    public List<Film> getSortedListOfDirectorsFilms(Integer directorId, String sortBy) {
        if (sortBy.equals("likes")) {
            try {
                ...
                log.error("Ошибка при получении списка фильмов режиссера {} отсортированных по лайкам", directorId);
            }
            ...
            try {
                ...
                log.error("Ошибка при получении списка фильмов режиссера {} отсортированных по году", directorId);
            }
        }
        return null;
    }
