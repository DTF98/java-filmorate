...
public class DirectorService {
    ...
    public Director getDirById(Integer id) {
    ...
    public Director addDir(Director director) {
        log.info("Добавление режисера: {}", director.getId());
        return directorStorage.add(director);
    }

    public Director updateDir(Director director) {
        log.info("Обновление режисера: {}", director.getId());
        return directorStorage.update(director);
    }

    public boolean deleteDirById(Integer id) {
